            ...
            <div className="container">
                ...
                <div className="kpi-grid">
                    ...
                    <div className="kpi-card">
                        ...
                        <div className="kpi-value">68<span style={{ fontSize: '1.5rem' }}>%</span></div>
                    ...
                    <div className="kpi-card">
                        ...
                        <div className="kpi-value">4.8<span style={{ fontSize: '1.5rem' }}>/5</span></div>
                    ...
                    <div className="chart-card">
                        ...
                        <div className="bar-chart-row">
                            ...
                            <div className="bar-track">
                                <div className="bar-fill" style={{ width: '92%', backgroundColor: 'var(--color-primary)' }}></div>
                            </div>
                        </div>
                        ...
                        <div className="bar-chart-row">
                            ...
                            <div className="bar-track">
                                <div className="bar-fill" style={{ width: '88%', backgroundColor: 'var(--color-primary)' }}></div>
                            </div>
                        </div>
                        ...
                        <div className="bar-chart-row">
                            ...
                            <div className="bar-track">
                                <div className="bar-fill" style={{ width: '85%', backgroundColor: 'var(--color-secondary)' }}></div>
                            </div>
                        </div>
                    </div>
